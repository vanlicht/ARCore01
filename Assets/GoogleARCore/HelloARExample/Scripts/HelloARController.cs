...
namespace GoogleARCore.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        /// </summary>
        public GameObject[] m_hologramPrefab;
        int hologramSum;
        int hologramCount = 0;
        ...
        public void Start()
        {
            hologramSum = m_hologramPrefab.Length;
        }
        /// <summary>
        ...
        public void Update ()
        {
            ...
            if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
            {
                ...
                if (hologramCount < hologramSum)
                {
                    andyObject = Instantiate(m_hologramPrefab[hologramCount], hit.Point, Quaternion.identity,
                       anchor.transform);
                    hologramCount++;
                }
                else
